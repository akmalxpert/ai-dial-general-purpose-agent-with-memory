...
class StoreMemoryTool(BaseTool):
    ...
    def description(self) -> str:
        return (
            "Stores a new long-term memory about the user. Use this tool to save important, novel facts "
            "such as preferences, personal information, goals, plans, or important context. "
            "Only store NEW information that hasn't been stored before. "
            "Extract clear, concise facts - one fact per memory call. "
            "Do NOT store temporary or conversational information. "
